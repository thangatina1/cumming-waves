...
const Navbar = () => {
  ...
  const menuOptions = [
    ...
    },
    {
      ...
      icon: <ShoppingCartRoundedIcon />, 
      link: "/schedule-tryout"
    },
    {
      text: "Collapsible Tree",
      icon: <InfoIcon />, 
      link: "/collapsible-tree"
    },
  ];
  return (
    <nav style={{
  ...
  <div className="navbar-links-container" style={{display: 'flex', alignItems: 'center', gap: 24, justifyContent: 'flex-start'}}>
        <Link to="/">Home</Link>
        ...
        <Link to="/coach-login" className="primary-button" style={{textDecoration: 'none', marginLeft: 8, marginRight: 0}}>
          Coach Login
        </Link>
