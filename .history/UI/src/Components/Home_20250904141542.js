    ...
    <div className="home-container">
      <div className="home-banner-container">
        ...
        <div className="home-text-section">
          ...
          <button className="primary-button" style={{textDecoration: 'none'}} onClick={() => navigate("/r") }>
            Join Now <FiArrowRight />
          </button>
          <button className="primary-button" style={{textDecoration: 'none'}} onClick={() => navigate("/join-now") }>
            Shedule Tryout <FiArrowRight />
          </button>
        </div>
