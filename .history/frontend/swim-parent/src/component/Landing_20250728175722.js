...
import { FaSwimmer, FaCoach, FaBuilding } from 'react-icons/fa';
  ...
  return (
    <div className="landing">
      <header className="landing-header">
        <FaSwimmer size={50} color="#0097A7" className="landing-logo" />
      ...
      <section className="landing-features">
        ...
        <div className="landing-features-grid">
          <div className="landing-feature">
            <FaCoach size={50} color="#0097A7" className="landing-feature-icon" />
          ...
          <div className="landing-feature">
            <FaBuilding size={50} color="#0097A7" className="landing-feature-icon" />
          ...
          <div className="landing-feature">
            <AiOutlineHeart size={50} color="#0097A7" className="landing-feature-icon" />
      ...
      <footer className="landing-footer">
        <IoIosPeople size={50} color="#0097A7" className="landing-footer-icon" />
