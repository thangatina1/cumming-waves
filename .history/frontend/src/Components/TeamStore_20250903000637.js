...
const TeamStore = () => {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "40px auto", padding: 24, position: 'relative' }}>
      {/* Cart and Checkout UI */}
      <div style={{ position: 'absolute', top: 24, right: 24, zIndex: 10, minWidth: 320 }}>
        <div style={{ background: '#fff', border: '2px solid #0077b6', borderRadius: 12, boxShadow: '0 2px 8px #0077b633', padding: 18, minWidth: 260 }}>
