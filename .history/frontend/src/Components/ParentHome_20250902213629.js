      ...
      {showPaymentOptions && (
        <div style={{
          ...
          <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16}}>
            <span style={{fontWeight: 600, fontSize: '1.15rem'}}>Choose Payment Method</span>
            <button onClick={() => setShowPaymentOptions(false)} style={{background: 'none', border: 'none', fontSize: 18, cursor: 'pointer', color: '#888'}}>✕</button>
          </div>
          <div style={{display: 'flex', flexDirection: 'column', gap: 18}}>
            <button style={{
              ...
              onClick={() => alert('Credit/Debit Card payment flow (to be implemented)')}
            >
              💳 Credit / Debit Card
            </button>
            <button style={{
              ...
              onClick={() => alert('PayPal payment flow (to be implemented)')}
            >
