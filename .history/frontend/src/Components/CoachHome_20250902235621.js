...
const CoachHome = () => {
  ...
  <div className="register-container swimmer-register-card" style={{position: 'relative', width: '100%', textAlign: 'left', padding: '2.5rem 2.5rem 2rem 2.5rem', boxSizing: 'border-box'}}>
      ...
      {/* Shared tile style for consistent size and padding */}
      {(() => {
        var tileStyle = {
          borderRadius: 18,
...
// Repeat for all other tiles: use ...tileStyle and only override background, border, color, boxShadow, cursor as needed
  );
  })()}
