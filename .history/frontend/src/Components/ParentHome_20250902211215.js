            ...
            return (
              <React.Fragment key={swimmer._id}>
                <tr>
                  ...
                  <td>
                    <button className="primary-button" style={{padding: '0.2rem 0.7rem', fontSize: '0.95rem', marginRight: 8}} onClick={() => setShowLog(showLog === swimmer._id ? null : swimmer._id)}>
                      {showLog === swimmer._id ? 'Hide Log' : 'View Log'}
                    </button>
                    {hasDue
                      ? <MdErrorOutline title="Payment Due" style={{color: 'red', fontSize: '1.3rem', verticalAlign: 'middle'}} />
                      : <MdCheckCircleOutline title="All Paid" style={{color: 'green', fontSize: '1.3rem', verticalAlign: 'middle'}} />
                    }
                  </td>
                </tr>
                {showLog === swimmer._id && (
