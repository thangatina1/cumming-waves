...
const TeamStore = () => {
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "40px auto", padding: 24, position: 'relative', minHeight: 600 }}>
      {/* Cart and Checkout UI styled like CoachHome profile card */}
      <div style={{ position: 'absolute', top: 24, right: 24, zIndex: 10, minWidth: 320 }}>
      ...
      <h2 style={{ textAlign: "left", marginBottom: 32, color: "#0077b6", marginLeft: 12 }}>Team Store</h2>
      <div style={{ display: "flex", flexDirection: 'row', flexWrap: "wrap", gap: 32, justifyContent: "flex-end", alignItems: 'stretch', width: '100%' }}>
        {storeItems.map((item) => {
