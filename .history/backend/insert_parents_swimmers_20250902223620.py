...
for i, (pname, pemail) in enumerate(parent_names):
    ...
    for j, cname in enumerate(children):
        ...
        swimmer_profile_pic = random.choice([
            f'https://randomuser.me/api/portraits/men/{((i*5+j)%50)+1}.jpg',
            f'https://randomuser.me/api/portraits/women/{((i*5+j)%50)+1}.jpg',
            f'https://randomuser.me/api/portraits/lego/{((i*5+j)%10)+1}.jpg',
            f'https://randomuser.me/api/portraits/med/men/{((i*5+j)%50)+1}.jpg',
            f'https://randomuser.me/api/portraits/med/women/{((i*5+j)%50)+1}.jpg',
            f'https://randomuser.me/api/portraits/med/lego/{((i*5+j)%10)+1}.jpg',
            'https://randomuser.me/api/portraits/women/44.jpg' if pemail == 'helen.lewis7@example.com' else None
        ])
        if pemail == 'helen.lewis7@example.com':
            swimmer_profile_pic = 'https://randomuser.me/api/portraits/women/44.jpg'
        swimmer = {
            ...
            'parent_id': parent_id,
            'profilePic': swimmer_profile_pic,
