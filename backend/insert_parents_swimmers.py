...
def main():
    username = 'thangavelramanathan_db_user'
    password = 'mylocaldb2025'
    # Connect to MongoDB Atlas with SSL certificate verification
    client = MongoClient(
    f'mongodb+srv://{username}:{password}@cluster0.pqfo2xt.mongodb.net/cumming-waves-db?retryWrites=true&w=majority',
